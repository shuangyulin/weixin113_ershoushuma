 ...
 */
@TableName("tongxin")
public class TongxinEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public TongxinEntity() {
		
	}
	
	public TongxinEntity(T t) {
		try {
	 ...
	 * 设置：发送内容
	 */
	public void setFasongneirong(String fasongneirong) {
		this.fasongneirong = fasongneirong;
	}
	/**
	 * 获取：发送内容
	 */
	public String getFasongneirong() {
		return fasongneirong;
	}
	/**
	 * 设置：卖家账号
	 */
